...
import EditFreePage from "./EditFreePage"
import ReadFreePage from "./ReadFreePage"
...
export default function FreePage() {
  ...
  return (
    <Container>
      ...
      {isEditing ? (
        <EditFreePage setIsEditing={setIsEditing} freeInfo={freeInfo} setFreeInfo={setFreeInfo} />
      ) : (
        <ReadFreePage

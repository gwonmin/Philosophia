...
export default function ServicePage() {
  return (
    <>
      <Typography variant="h5">필로소피아란?</Typography>
      ...
      <Typography variant="h5">AI와 함께하는 철학</Typography>
      <Typography variant="body1">
        서로를 비방하는 언행을 자제하며, 철학을 주제로 건전한 대화를 나눌 수 있는 양질의 토론장을 조성하기 위해 비속어 탐지 AI를 덧글에 적용하였습니다. 가벼운
      ...
      <Box sx={{ borderBottom: 1, borderColor: "divider", mb: 2, mt: 2 }} />
      <Typography variant="h5">팀 소개</Typography>
      <Typography variant="body1">AI : 양권민 AI : 정예승 FE : 명하준 FE : 주강현 BE : 유하얀 BE : 장준수</Typography>
    </>
  )
}

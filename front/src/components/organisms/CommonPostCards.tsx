      ...
      {postList != [] && (
        <div>
          ...
          {postList.map((post: Post) => {
            return <Exchange path={currentPage.DEFALUT.path} post={post} />
          })}
        </div>
      )}
    </div>
...
//-------------------------------------------exchange-------------------------------------------//
function Exchange({ path, post }: { path: string; post: Post }) {
  switch (path) {
    case "devates":
...
//-------------------------------------------Devate-------------------------------------------//
function Devate({ post }: { post: Post }) {
  return (
...
//-------------------------------------------Philosopher-------------------------------------------//
function Philosopher({ post }: { post: Post }) {
  return (
    <div key={post._id} style={{ backgroundColor: "grey" }}>
      <Link to={post._id}>
        <p>제목: {post.title}</p>
